...
__help__ = """
 • `/afk <reason>`*:* menandai kamu jika sedang AFK (away from keyboard).
 • `brb <reason>`*:* sama seperti AFK - tapi ini bukan command.
Jika anda ditandai saat AFK, semua mentions akan dibalas dengan alasan AFK!
"""
